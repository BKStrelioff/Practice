...
namespace Preferences.UnitTests
{
    ...
    /// <summary>
    ///     Class PostPersonColorPreferenceModelDtoUnitTests.
    /// </summary>
    /// <autogeneratedoc />
    /// TODO Edit XML Comment Template for PostPersonColorPreferenceModelDtoUnitTests
    public static class PostPersonColorPreferenceModelDtoUnitTests
    {
        ...
        {
            var actual = new PostPersonColorPreferenceModelDto();
        ...
        public static void Test_mapping_to()
        {
            ...
            var dto = original.To<PostPersonColorPreferenceModelDto>();
        ...
        public static void Test_mapping_to_enumerable()
        {
            ...
            var dtos = original.To<PostPersonColorPreferenceModelDto>().ToSafeList();
        ...
        {
            var original = PreferencesHelpers.GenerateRandomRecord(new Random());
            var copy = new PostPersonColorPreferenceModelDto().PopulateFrom(original);
